/* The purpose of this php method is to return all treasure hunts associated with a given participant that have not yet been started.*/
...
<?php
	...
	try {	
		//Grab all of the hunt ids that are associated with the given participant
		...
		//For each of these treasure hunts
		foreach($hunts as $huntIdReturned)
		{
			try {	
				//Return the associated hunt as part of a list where the hunt has been registered with but not yet started.
