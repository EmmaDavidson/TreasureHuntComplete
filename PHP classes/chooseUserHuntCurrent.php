/* The purpose of this php method is to return all treasure hunts associated with a given participant that are currently being played.*/
...
<?php
	...
	try {	
		//Grab all of the treasure hunt ids associated with this participant
		...
		//For each of the ids returned
		foreach($hunts as $huntIdReturned)
		{
			try {	
				//Return the associated hunt as part of a list if it is currently being played and is not out of date.
